...
function ProfileCard() {
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100 dark:bg-gray-900">
      <div className="bg-white dark:bg-gray-800 min-w-[380px] max-w-[450px] md:max-w-[550px] lg:max-w-[650px] h-auto rounded-2xl shadow-lg shadow-cyan-700 dark:shadow-cyan-500">
